...
Dim OB As Object
    ...
    If mValue = True Then CheckEnabled: Exit Sub 'Check Enabled must be here 'cause if user is
        ...
        For Each OB In Parent.Controls
            If TypeOf OB Is OptionButton Then
