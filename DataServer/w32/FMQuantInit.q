...
show `$"Creat Table..."
Position:([Code:`symbol$()]Vol:`int$();VolA:`int$();VolFrozen:`int$();StockActualVol:`int$();AvgCost:`float$();PriceNow:`float$();MktValue:`float$();FloatingProfit:`float$();ProfitRatio:`float$();Currency:`symbol$();Mkt:`symbol$();AccountID:`guid$();Config:`symbol$());
OrderList:([OrderID:`symbol$()]Code:`symbol$();Direction:`int$();Price:`float$();Volume:`int$();VolumeMatched:`int$();State:`symbol$();AvgMatchingPrice:`float$();OrderTime:`datetime$();Mkt:`symbol$();AccountID:`guid$();Config:`symbol$());
